 ...
 */
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Enter Professor's ID Number:");

        jLabel3.setText("Professor's Name:");

        jLabel4.setText("Date and Time:");

        jLabel5.setText("Professor's Department:");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        JOptionPane.showMessageDialog(null, "You have an appointment with Professor " + DoctorName + " of department: " + Depart + " at: " + DateTime + " . Kindly be on time.");
